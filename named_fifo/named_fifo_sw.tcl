...
add_sw_setting boolean system_h_define stdin.back_pressure NAMED_FIFO_STDIN_BACK_PRESSURE 1 "If back-pressure is enabled, writing to full buffer will be blocked. If back-pressure is disabled, writing to full buffer will overwrite old data."
...
add_sw_setting boolean system_h_define stdout.back_pressure NAMED_FIFO_STDOUT_BACK_PRESSURE 0 "If back-pressure is enabled, writing to full buffer will be blocked. If back-pressure is disabled, writing to full buffer will overwrite old data."
...
add_sw_setting boolean system_h_define stderr.back_pressure NAMED_FIFO_STDERR_BACK_PRESSURE 0 "If back-pressure is enabled, writing to full buffer will be blocked. If back-pressure is disabled, writing to full buffer will overwrite old data."
